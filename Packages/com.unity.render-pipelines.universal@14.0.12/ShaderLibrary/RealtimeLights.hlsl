...
Light GetMainLightNoToon(float4 shadowCoord, float3 positionWS, half4 shadowMask)
{
    Light light = GetMainLight();
    light.shadowAttenuation = MainLightNoToonShadow(shadowCoord, positionWS, shadowMask, _MainLightOcclusionProbes);
