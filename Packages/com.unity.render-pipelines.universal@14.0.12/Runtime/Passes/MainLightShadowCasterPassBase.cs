...
{
    public class MainLightShadowCasterPassBase :  ScriptableRenderPass
    {
        ...
        protected virtual string k_MainLightShadowMapTextureName { get; }
        protected virtual string k_EmptyMainLightShadowMapTextureName { get; }
        ...
        protected virtual ProfilingSampler m_ProfilingSetupSampler { get; }

        internal virtual URPProfileId m_MainLightProfileId { get; }
        ...
        public MainLightShadowCasterPassBase(RenderPassEvent evt)
        {
        ...
        protected virtual void RenderMainLightCascadeShadowmap(ref ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(m_MainLightProfileId)))
            {
        ...
        {
            internal MainLightShadowCasterPassBase pass;
